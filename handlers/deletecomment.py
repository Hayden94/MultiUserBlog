...
class DeleteComment(Handler):
	...
	def post(self, post_id, comment_id):
		...
		# if user is not the author of the comment      
			...
			self.render('information.html', title = title, error = error, link_src = link_src, link_name = link_name)
		else:
			comment.delete()
			...
			self.render('information.html', message = message, post_id = post_id, link_src = link_src, link_name = link_name)